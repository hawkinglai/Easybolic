...
from .ops.manifold_layers import MobiusLayer
...
class Hype_Model(nn.Module):
    def __init__(self, points=1024, class_num=40, embed_dim=64, groups=1, res_expansion=1.0,
        ...
        self.proj = nn.Sequential(nn.Linear(1024, 512, bias=False),nn.BatchNorm1d(512) ,self.act)
...
if __name__ == '__main__':
    data = torch.rand(2, 3, 1024).to('cuda:0')
